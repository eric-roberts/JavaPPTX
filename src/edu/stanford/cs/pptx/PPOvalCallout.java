/*
 * File: PPOvalCallout.java
 * ------------------------
 * This class represents an ellipse with a callout wedge.
 */
...
public class PPOvalCallout extends PPAutoShape {

/**
 * Creates a new <code>PPOvalCallout</code> shape with the specified
 ...
 */
   ...
   public PPOvalCallout(double x, double y, double width, double height) {
      setBounds(x, y, width, height);
   }

/**
 * Creates a new <code>PPOvalCallout</code> shape from the specified
 * coordinates and size.  This version of the constructor operates in
 * much the same manner as the standard
 * {@link #PPOvalCallout(double,double,double,double) PPOvalCallout}
...
/**
 * Creates a new <code>PPOvalCallout</code> shape from its dimensions.
 ...
 */
   ...
   public PPOvalCallout(double width, double height) {
      this(0, 0, width, height);
   }

/**
 * Creates a new <code>PPOvalCallout</code> shape from its dimensions and
 * an options string.
 *
 * @param width The width of the oval
 * @param height The height of the oval
 ...
 */
   ...
   public PPOvalCallout(double width, double height, String options) {
      this(width, height);
      setOptions(options);
   }
