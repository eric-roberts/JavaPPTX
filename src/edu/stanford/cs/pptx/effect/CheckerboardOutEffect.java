/*
 * File: CheckerboardOutEffect.java
 * --------------------------------
 * This class implements the checkerboard-out effect.
 */
...
/**
 * This exit effect causes the shape to disappear in a checkerboard pattern.
...
public class CheckerboardOutEffect extends AnimationEffect {

   public CheckerboardOutEffect() {
      super("CheckerboardOut");
   }

   @Override
   public String getPresetTag() {
      return "presetID='5' presetClass='exit' presetSubtype='10'";
   }

   @Override
   public void dumpBehavior(PPOutputStream os, String delayTag) {
      os.print("<p:animEffect transition='out' filter='checkerboard(" +
               getDirection() + ")'>");
      os.print("<p:cBhvr>");
