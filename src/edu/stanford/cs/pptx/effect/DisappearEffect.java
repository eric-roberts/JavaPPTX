/*
 * File: DisappearEffect.java
 * --------------------------
 * This class implements the Disappear effect.
 */
...
/**
 * This exit effect causes the shape to disappear in response to the
 * trigger event, which defaults to <code>/onClick</code>.
...
public class DisappearEffect extends AnimationEffect {
   ...
   public String getPresetTag() {
      return "presetID='1' presetClass='exit' presetSubtype='0'";
   }
