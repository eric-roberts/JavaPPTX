/*
 * File: FadedZoomOutEffect.java
 * -----------------------------
 * This class implements the FadedZoomOut effect.
 */
...
/**
 * This exit effect combines the fade and zoom animations.  The legal
 * options are:
 *
 * <table border=0>
...
public class FadedZoomOutEffect extends AnimationEffect {

   public FadedZoomOutEffect() {
      super("FadedZoomOut");
   }
   ...
   public String getPresetTag() {
      return "presetID='53' presetClass='exit' presetSubtype='0'";
   }
