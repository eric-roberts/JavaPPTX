/*
 * File: ChangeLineColorEffect.java
 * --------------------------------
 * This class implements the ChangeLineColor effect.
 */
...
/**
 * This emphasis effect change the line color of the shape gradually over
...
public class ChangeLineColorEffect extends AnimationEffect {

   public ChangeLineColorEffect() {
      super("ChangeLineColor");
   }
   ...
   public String getPresetTag() {
      return "presetID='7' presetClass='emph' presetSubtype='2'";
   }
   ...
   public void dumpBehavior(PPOutputStream os, String delayTag) {
      ...
      os.print("<p:attrName>stroke.color</p:attrName>");
      os.print("</p:attrNameLst>");
      os.print("</p:cBhvr>");
      ...
      os.print("</p:tgtEl>");
      os.print("<p:attrNameLst>");
      os.print("<p:attrName>stroke.on</p:attrName>");
      os.print("</p:attrNameLst>");
      os.print("</p:cBhvr>");
      os.print("<p:to>");
