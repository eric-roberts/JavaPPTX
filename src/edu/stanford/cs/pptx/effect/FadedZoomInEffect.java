/*
 * File: FadedZoomInEffect.java
 * ----------------------------
 * This class implements the FadedZoomIn effect.
 */
...
/**
 * This entrance effect combines the fade and zoom animations.  The legal
 * options are:
 *
 * <table border=0>
...
public class FadedZoomInEffect extends AnimationEffect {

   public FadedZoomInEffect() {
      super("FadedZoomIn");
   }
   ...
   public String getPresetTag() {
      return "presetID='53' presetClass='entr' presetSubtype='0'";
   }
